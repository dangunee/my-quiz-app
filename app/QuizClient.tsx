  ...
  const desktopMenu = (
    <>
      {desktopMenuCollapsed ? (
        <button
          type="button"
          onClick={() => setDesktopMenuCollapsed(false)}
          className="hidden md:flex shrink-0 h-12 w-12 items-center justify-center rounded-2xl bg-white shadow-lg border border-gray-200 text-gray-600 hover:bg-gray-50"
          aria-label="メニューを開く"
        >
